...
- `ardupilot_gazebo-visual.patch`: adds the chase camera and introduces
  `iris_with_camera_calibration`, a rigid front-bottom camera calibration rig
  with 6-DOF Gazebo GUI controls that can be initialized from the configured
  deployment and reused to generate deterministic experiment/calibration
  runtime models

...
class ManualRuntimeRosIo:
    ...
    def _on_mc_state(self, msg: McState) -> None:
        self._runtime_state.update_mc_state(int(msg.mc_state_enum))

    def _on_hlc_state(self, msg: HlcState) -> None:
        self._runtime_state.update_hlc_state(int(msg.hlc_state_enum))
    ...
    def _on_telemetry(self, msg: HlcTelemetry) -> None:
        ...
        self._runtime_state.update_telemetry(telemetry, now_sec)

    def _on_error(self, msg: HlcPlatformError) -> None:
        self._runtime_state.update_error(msg.error_text)
